...
export const LocationDoctors = () => {
  ...
  className="flex md:py-4 lg:flex-row md:w-[750px] lg:w-[520px] xl:w-[620px] lg:h-16 items-center text-left justify-between px-4"
> 
    <div className="flex flex-col">
        <div className="lg:text-[8px] xl:text-[9px] text-green2">Location</div>
        <div className="lg:text-[9px] xl:text-[11px] mt-[2px]">Delhi</div>
      </div>
      ...
      <button
        className="text-white md:h-10 md:w-36 lg:h-8 lg:w-28 xl:h-10 xl:w-32 xl:p-2 rounded-md font-[Poppin] ml-20"
        style={{
